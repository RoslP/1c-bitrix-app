...
<head>
    ...
    //fonts (google fonts)
    Asset::getInstance()->getStrings('<link href="https://fonts.googleapis.com/css?family=Lato:300,400,700" rel="stylesheet">');
    ?>
</head>
<body>
<!--[if lt IE 8]>
        ...
        <div class="container">
            <div class="full-width-mega-dropdown">
                <div class="row">
                    ...
                    <div class="col-mb-10 col-sm-9 col-xl-4 text-right dark-menu">
